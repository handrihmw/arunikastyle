    ...
    <div class="block-website__content-list">
        <div class="row">
            <div class="col-12 col-md-6 col-xl-4" 
              ...
              :key="listIndex">
                <div :class="buttonlocation == 'bottom' ? 'block-website__content-list-item block-website__content-list-item--height-95 mb-0':'block-website__content-list-item block-website__content-list-item--height-100'" v-if="list.page == currentPage">
                    <div :class="buttonlocation == 'bottom' ? 'block-website__content-list-item-box block-website__content-list-item-box--box-shadow block-website__content-list-item-box--with-button-bottom' : 'block-website__content-list-item-box block-website__content-list-item-box--box-shadow'">
                        <div v-if="list.item.gimmick_discount && parseFloat(list.item.gimmick_discount) > 0 && withRibbonDiscount && withRibbonDiscount > 0" class="badge-promotion-top">
                          <div class="badge-promotion__decoration"></div>
                        ...
                        <div class="block-website__content-list-item-box-image block-website__content-list-item-box-image--new">
                            <div v-if="list.item.gimmick_discount && parseFloat(list.item.gimmick_discount) > 0 && withRibbonDiscount  && withRibbonDiscount > 0" :class="[list.item.more_gimmick_discount && parseFloat(list.item.more_gimmick_discount) > 0 ? 'badge-promotion-bottom badge-promotion-bottom--with-more-discount' : 'badge-promotion-bottom badge-promotion-bottom-default']">
                              <div class="badge-promotion__percentage">{{list.item.gimmick_discount}}</div>
                              <div v-if="list.item.more_gimmick_discount && parseFloat(list.item.more_gimmick_discount) > 0" class="badge-promotion__more">
                                <div class="badge-promotion__more-discount">+ {{list.item.more_gimmick_discount}} %
                                  <div class="badge-promotion__more-decoration-block badge-promotion__more-decoration-block-left"></div>
                                  <div class="badge-promotion__more-decoration-block badge-promotion__more-decoration-block-right"></div>
                                  <div class="badge-promotion__more-decoration-circle badge-promotion__more-decoration-circle-left"></div>
                                  <div class="badge-promotion__more-decoration-circle badge-promotion__more-decoration-circle-right"></div>
                                </div>
                              </div>
                            </div>
                            ...
                            <div class="block-website__content-list-item-box-image-overlay-wrap">
                              ...
                              <div v-if="buttonlocation != 'bottom'" class="block-website__content-list-item-box-image-overlay-new">
                                  ...
                                  <a href="javascript:void(0)" class="nh-btn nh-btn--color-orange nh-btn--white nh-btn--border-orange text-uppercase" v-on:click="updateOrder(list.item)">Pilih Website Ini</a>
                              </div>
                            </div>
                        </div>
                    ...
                    <div v-if="buttonlocation == 'bottom' " class="block-website__footer">
                      <a href="javascript:void(0)" class="nh-btn nh-btn--orange nh-btn--padding-top-bottom-16-right-left-32 text-uppercase mb-5" v-on:click="previewModal(list.item)">Pilih Website Ini</a>
                    </div>
                </div>
            </div>
