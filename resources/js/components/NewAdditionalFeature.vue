<template>
    <section class="additional-feature">
        <h3 class="additional-feature__title">Rekomendasi Fitur Tambahan</h3>
        <div class="additional-feature__addon" v-if="flow !== 'vps'">
            <div v-if="flow !== 'mailhosting'">
              <div class="row mb-5" v-if="! this.isWordpressHosting()">
                  ...
                  <div class="col-12 col-lg-10">
                      ...
                      <div class="row align-items-start">
                          ...
                          <div class="col-4 col-lg-2">
                              <div @click="autoInstallWebsite"
                                  :class="{'additional-feature__addon-cart--selected': additional_feature.wordpress.selected == true }"
                                  class="additional-feature__addon-cart gtmAddon" data-addon="Auto Install Website Wordpress">
                                  <input type="hidden" name="wordpress" value="1"
                                      v-model="additional_feature.wordpress.selected" />
                              </div>
                          </div>
                      </div>
                  </div>
                ...
                <div class="row mt-5 mb-5">
                    ...
                    <div class="col-12 col-lg-10">
                        <p class="additional-feature__addon-title">
                            ...
                            <span class="additional-feature__addon-title--sub">mulai dari Rp {{sslPriceStartingFrom()}}rb/domain per tahun</span>
                        </p>
                        <div class="row align-items-start">
                            <div class="col-8 col-lg-10">
                            ...
                            <div class="col-4 col-lg-2">
                                <div @click="addRemoveSSLToCart"
                                    :class="{'additional-feature__addon-cart--selected': additional_feature.ssl.selected }"
                                    class="additional-feature__addon-cart gtmAddon" data-addon="Keamanan SSL Certificate (HTTPS)">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row align-items-start">
                            ...
                            <div class="col-4 col-lg-2">
                                <div @click="addRemovePrivacyProtectionToCart"
                                    ...
                                    <input type="hidden" name="privacy_protection" value="1"
                                        v-model="additional_feature.domainprivacy.selected" />
                                </div>
                            </div>
                        </div>
                    </div>
                  ...
                  >
                    <p class="additional-feature__select-title">
                      <strong>
                        ...
                        <span
                          v-if="additional_feature.vps.price"
                          class="float-right pr-lg-5 d-none d-lg-block"
                        >
